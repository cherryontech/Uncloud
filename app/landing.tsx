	...
	return (
		<div className='landingContainer'>
			...
			<div className='content flex w-full flex-col items-center justify-center'>
				...
				{/* App Features Cards */}
				<div className='flex max-w-[64.375rem] flex-row gap-20 px-8'>
				...
				{/* Carousel */}
				<div className='carousel-1 flex flex-col items-center justify-center gap-12'>
					{/* Carousel Menu*/}
				...
				{/* Marketing Quote */}
				<div className='flex flex-col items-center justify-center gap-2 pt-[9.61rem]'>
				...
				<div className='flex flex-col items-start gap-8 pt-[9.63rem]'>
					<div className='flex flex-row items-center gap-2'>
				...
				<div className='flex flex-col gap-[3.95rem] pt-[32rem]'>
